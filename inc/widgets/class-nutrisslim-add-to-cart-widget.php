...
<div class="customAddToCart">
    ...
    <div class="featureWrapper">
        ...
        <div class="feature delivery"><img src="/wp-content/plugins/nutrisslim-suiteV2/assets/cart_dostava_ico.svg" />
            <?php printf(__('Delivery in 2 business days', 'nutrisslim-suiteV2'), '1-3'); ?></div>
    </div>

    <div class="payment-logos col-12 row mx-0">
        <div class="payment-method pl-0">
            <img class="visa" style="max-width:70%!important;" src="/wp-content/plugins/nutrisslim-suiteV2/assets/visa-color.png" alt="visa">
        </div>
        <div class="payment-method pl-0">
            <img class="mastercard" style="max-width:70%!important;" src="/wp-content/plugins/nutrisslim-suiteV2/assets/mastercard-color.png"
                alt="mastercard">
        </div>
        <div class="payment-method pl-0">
            <img class="american_express" style="max-width:70%!important;" src="/wp-content/plugins/nutrisslim-suiteV2/assets/american_express-color.png"
