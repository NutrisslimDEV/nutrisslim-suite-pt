                                ...
                                <label for="checked0<?php echo $num; ?>">
                                    ...
                                    <?php 
                                                            if ($consumption_period && $duration > 0) {
                                                                echo '<p style="font-size: smaller; padding-left: 20px; font-weight:300; padding-top: 10px"> durante ' . $duration . ' dias</p>';
                                                            }
                                                            ?>
                                </label>
                            </div>
...
<!-- ---------------------- UPSell Block C (Same as A but with Price-per-product) ---------------------- -->
        <?php if ($upsell_block_option == 'upsell-block-c') : ?>
            ...
            <div id="upsell-block" class="style-c<?php echo $upsell_block_option == 'upsell-block-c' ? '' : ' d-none'; ?>"
                ...
                $custom_titles = array(
                    1 => !empty($package_1_text_c) ? $package_1_text_c : __('1+1 GRÁTIS', 'nutrisslim-suite'),
                    2 => !empty($package_2_text_c) ? $package_2_text_c : __('2+2 GRÁTIS ', 'nutrisslim-suite'),
                    3 => !empty($package_3_text_c) ? $package_3_text_c : __('3+3 GRÁTIS ', 'nutrisslim-suite'),
                );
                ...
                $custom_subtitles = array(
                    ...
                    2 => !empty($package_2_subtitle_c) ? $package_2_subtitle_c : __('+ poupar 5% extra', 'nutrisslim-suite'),
                    3 => !empty($package_3_subtitle_c) ? $package_3_subtitle_c : __('+ poupar 10% extra', 'nutrisslim-suite'),
                );

                // Upsell block C - custom main text

                $custom_titles2 = array(
                    1 => !empty($package_1_maintext_c) ? $package_1_maintext_c : __('Obter 2 produtos', 'nutrisslim-suite'),
                    2 => !empty($package_2_maintext_c) ? $package_2_maintext_c : __('Obter 4 produtos', 'nutrisslim-suite'),
                    3 => !empty($package_3_maintext_c) ? $package_3_maintext_c : __('Obter 6 produtos', 'nutrisslim-suite'),
                );
                ...
                foreach ($quantities as $key => $item) {
                    ...
                    if ($key == 1) {
                        echo '<div class="text-center cta-notice mobile"><h3>' . __('Comprar mais, poupar mais', 'nutrisslim-suite') . '</h3></div>';
                    }
                            ...
                            <div class="offer-container">
                                ...
                                <div class="bottom">
                                    ...
                                    <span class="price-per-product-text">
                                        ...
                                        <?php _e('/ por produto', 'nutrisslim-suite'); ?>
                                    </span>
                                            </div>
                                        ...
                                        <div class="offer-left">
                                            ...
                                            <span class="line-through precrtano regularofferc">
                                                <?php
                                                echo sprintf(
                                                    __('Preço normal. %s', 'nutrisslim-suite'),
                                    ...
                                    <?php if ($quantities[$key]['free_shipping'] || $freeshipping) { ?>
                                        <div class="offer_shipping">
                                            ...
                                            <?php _e('Entrega gratuita', 'nutrisslim-suite'); ?>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <?php if (!empty($quantities[$key]['gift']) && isset($quantities[$key]['gift'][0])) { ?>
                                        <div class="offer_shipping">
                                            ...
                                            <?php _e('Oferta gratuita', 'nutrisslim-suite'); ?>
                                        </div>
                                    <?php } ?>
