    ...
    function filter_submit_review_page_content( string $content ): string {
        ...
        <div class="mass-reviews container container-px">
            <div class="review-intro">
                <h1 class="bold"><?php echo esc_html__('A sua opinião é importante para nós', 'nutrisslim-suite'); ?></h1>
                <p><?php echo esc_html__('Na Nature\'s Finest, esforçamo-nos sempre por fornecer os melhores produtos e serviços aos nossos estimados clientes. Gostaria de avaliar a sua última compra?', 'nutrisslim-suite'); ?></p>
                <p><?php echo esc_html__('Como agradecimento pelo seu tempo, enviaremos um presente especial juntamente com a sua encomenda!', 'nutrisslim-suite'); ?></p>

                <h4><?php echo esc_html__('A sua encomenda', 'woocommerce'); ?></h4>
                ...
                <h4><?php echo esc_html__('Avalie e deixe a sua avaliação da compra', 'nutrisslim-suite'); ?></h4>
            </div>
            ...
            <div class="form">
                <div class="nf-review_form">
                    <div class="review_fields">
                        ...
                        <textarea name="review_review" id="review_text" cols="30" rows="5" placeholder="<?php echo esc_attr__('Diga-nos o que pensa','nutrisslim-suite'); ?>"></textarea>
                        <button id="send_reviews"><?php echo esc_html__('Enviar','woocommerce'); ?></button>
                    </div>
                </div>
            </div>
        </div>
